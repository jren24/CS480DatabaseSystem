...
<form action="<c:url value='/PeopleServletInsert'/>" method="post">
	<input type="hidden" name="method" value="People Insert"/>
	<!-- Number    :<input type="text" name="number" value="${form.number }"/>
	<span style="color: red; font-weight: 900">${errors.number }</span>
	<br/> -->
	HospitalName	：<input type="text" name="hospital_name" value="${form.hospital_name }"/>
	...
	<br/>
	<input type="submit" value="People Insert"/>
</form>
  </body>
</html>
